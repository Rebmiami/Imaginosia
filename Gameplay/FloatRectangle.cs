...
namespace Imaginosia.Gameplay
{
    ...
    public struct FloatRectangle : IEquatable<FloatRectangle>
    {
        ...
        /// <summary>
        /// Gets the hash code of this <see cref="FloatRectangle"/>.
        /// </summary>
        /// <returns>Hash code of this <see cref="FloatRectangle"/>.</returns>
        ...
        /// <summary>
        /// Gets whether or not the other <see cref="FloatRectangle"/> intersects with this rectangle.
        /// </summary>
        /// <param name="value">The other rectangle for testing.</param>
        /// <returns><c>true</c> if other <see cref="FloatRectangle"/> intersects with this rectangle; <c>false</c> otherwise.</returns>
        ...
        /// </summary>
        /// <param name="value">The other rectangle for testing.</param>
        /// <param name="result"><c>true</c> if other <see cref="FloatRectangle"/> intersects with this rectangle; <c>false</c> otherwise. As an output parameter.</param>
        ...
        /// <summary>
        /// Creates a new <see cref="FloatRectangle"/> that contains overlapping region of two other rectangles.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="FloatRectangle"/> that completely contains two other rectangles.
        /// </summary>
        /// <param name="value1">The first <see cref="FloatRectangle"/>.</param>
        /// <param name="value2">The second <see cref="FloatRectangle"/>.</param>
        ...
        /// <summary>
        /// Deconstruction method for <see cref="FloatRectangle"/>.
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
